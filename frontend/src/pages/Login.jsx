...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.erro || err.response?.data?.error || 'Erro ao fazer login. Tente novamente.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 w-full">
        <div className="w-full max-w-[480px] flex flex-col gap-6">
          ...
          <div className="text-center space-y-2 mb-4">
            ...
            <h2 className="text-xl text-text-secondary font-medium">Bem-vindo de volta, atleta!</h2>
          </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    className="w-full h-14 pl-12 pr-4 bg-slate-900 border border-border-color rounded-xl text-text-main placeholder-slate-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all duration-200"
                    id="email"
                    name="email"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    className="w-full h-14 pl-12 pr-12 bg-slate-900 border border-border-color rounded-xl text-text-main placeholder-slate-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all duration-200"
                    id="senha"
                    name="senha"
                    placeholder="••••••••"
              ...
              <div className="relative flex py-2 items-center">
                ...
                <span className="flex-shrink-0 mx-4 text-text-secondary text-sm">ou continue com</span>
                <div className="flex-grow border-t border-border-dark"></div>
              </div>
